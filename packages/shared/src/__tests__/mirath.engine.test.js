...
const mirath_engine_1 = require("../engines/mirath.engine");
const zakat_engine_1 = require("../engines/zakat.engine");
...
runTest('Test Case 1: Simple Spouse + Children', () => {
    ...
    const result = (0, mirath_engine_1.calculateMirath)(input);
...
runTest('Test: wealth below Nisab', () => {
    const result = (0, zakat_engine_1.calculateZakat)({
